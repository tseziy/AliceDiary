...
def hello():
    ...
    tts = (
        "Привет! Это цифрофой дневник для школьников из города Санкт-Петербурга."
        "Я могу подсказать расписание уроков или напомнить, что задали домой."
        "Скажите Что ты умеешь и расскажу подробнее."
        "Но для начала работы надо выполнить простые настройки."
        "Если готовы продолжить, скажите ДА"
    )
...
def FIO_needs():
    text = "Нужно обязательно назвать Фамилию и Имя ученика. Назовите, пожалуйста."
    tts = text
